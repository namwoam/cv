...
if __name__ == '__main__':
    ...
    dst = np.zeros((h, w, c))
    H = solve_homography(corners1, ref_corns)
    output3_1 = warping(secret1, dst, H, 0, w, 0, h, direction='b')
    dst = np.zeros((h, w, c))
    H = solve_homography(corners2, ref_corns)
    output3_2 = warping(secret2, dst, H, 0, w, 0, h, direction='b')
